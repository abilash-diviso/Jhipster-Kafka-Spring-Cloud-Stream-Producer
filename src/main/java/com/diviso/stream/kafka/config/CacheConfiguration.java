...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JhipsterKafkaStreamCloud");
        ...
        config.getMapConfigs().put("com.diviso.stream.kafka.domain.*", initializeDomainMapConfig(jHipsterProperties));
