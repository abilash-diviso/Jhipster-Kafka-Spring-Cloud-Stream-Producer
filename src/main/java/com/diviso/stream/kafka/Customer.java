...
public class Customer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord,Serializable {
  private static final long serialVersionUID = 4854928353391721041L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Customer\",\"namespace\":\"com.diviso.stream.kafka\",\"fields\":[{\"name\":\"customerId\",\"type\":\"long\"},{\"name\":\"customerName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.diviso.stream.kafka.Customer.Builder newBuilder() {
    return new com.diviso.stream.kafka.Customer.Builder();
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static com.diviso.stream.kafka.Customer.Builder newBuilder(com.diviso.stream.kafka.Customer.Builder other) {
    return new com.diviso.stream.kafka.Customer.Builder(other);
  }
   ...
   * @return A new Customer RecordBuilder
   */
  public static com.diviso.stream.kafka.Customer.Builder newBuilder(com.diviso.stream.kafka.Customer other) {
    return new com.diviso.stream.kafka.Customer.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Customer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.diviso.stream.kafka.Customer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.diviso.stream.kafka.Customer other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.customerId)) {
        this.customerId = data().deepCopy(fields()[0].schema(), other.customerId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.stream.kafka.Customer.Builder setCustomerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.stream.kafka.Customer.Builder clearCustomerId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.stream.kafka.Customer.Builder setCustomerName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.stream.kafka.Customer.Builder clearCustomerName() {
      customerName = null;
