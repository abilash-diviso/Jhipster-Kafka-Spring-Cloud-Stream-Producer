package com.diviso.stream.kafka.repository;

import com.diviso.stream.kafka.JhipsterKafkaStreamCloudApp;
import com.diviso.stream.kafka.config.Constants;
import com.diviso.stream.kafka.config.audit.AuditEventConverter;
import com.diviso.stream.kafka.domain.PersistentAuditEvent;
...
import static com.diviso.stream.kafka.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
